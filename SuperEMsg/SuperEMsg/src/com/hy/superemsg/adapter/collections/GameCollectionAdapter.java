...
public class GameCollectionAdapter extends GameListAdapter {

    public GameCollectionAdapter(Context ctx) {
        super(ctx);
    }
                ...
                new AlertDialog.Builder(getContext()).setMessage("是否取消收藏?")
                        .setPositiveButton("确定", new OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                DBUtils.getInst().remove(DBHelper.TABLE_GAME_COLLECTION, data);
                                removeData(data);
