...
public class RingCollectionAdapter extends RingListAdapter {

    public RingCollectionAdapter(Context ctx) {
        super(ctx);
    }
                ...
                new AlertDialog.Builder(getContext()).setMessage("是否取消收藏?")
                        .setPositiveButton("确定", new OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                DBUtils.getInst().remove(DBHelper.TABLE_RING_COLLECTION, data);
                                removeData(data);
