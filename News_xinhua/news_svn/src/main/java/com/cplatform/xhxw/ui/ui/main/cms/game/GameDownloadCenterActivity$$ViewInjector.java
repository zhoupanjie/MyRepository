...
public class GameDownloadCenterActivity$$ViewInjector {
  public static void inject(Finder finder, final com.cplatform.xhxw.ui.ui.main.cms.game.GameDownloadCenterActivity target, Object source) {
    View view;
    view = finder.findById(source, 2131492972);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131492972' for field 'lv' was not found. If this view is optional add '@Optional' annotation.");
    }
