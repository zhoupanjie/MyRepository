...
public class FriendsFreshInfoActivity$$ViewInjector {
  public static void inject(Finder finder, final com.cplatform.xhxw.ui.ui.main.saas.addressBook.FriendsFreshInfoActivity target, Object source) {
    View view;
    ...
    view = finder.findById(source, 2131492998);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131492998' for field 'mWebView' was not found. If this view is optional add '@Optional' annotation.");
    }
  ...
  public static void reset(com.cplatform.xhxw.ui.ui.main.saas.addressBook.FriendsFreshInfoActivity target) {
