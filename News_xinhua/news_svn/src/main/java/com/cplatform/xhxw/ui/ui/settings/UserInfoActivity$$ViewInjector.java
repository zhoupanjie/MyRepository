...
public class UserInfoActivity$$ViewInjector {
  public static void inject(Finder finder, final com.cplatform.xhxw.ui.ui.settings.UserInfoActivity target, Object source) {
    ...
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131493205' for field 'mAvatar' and method 'onAvatarAction' was not found. If this view is optional add '@Optional' annotation.");
    }
    ...
    view = finder.findById(source, 2131493249);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131493249' for method 'onSaveAction' was not found. If this view is optional add '@Optional' annotation.");
    }
    view.setOnClickListener(
      new android.view.View.OnClickListener() {
        @Override public void onClick(
