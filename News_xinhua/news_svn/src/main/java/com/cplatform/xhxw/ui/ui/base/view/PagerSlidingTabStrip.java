...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = 0xFF129bfb;
	private int underlineColor = 0xFF129bfb;
	...
	private int selectTabTextSize = 18;
	private int selectTabTextColor = 0xFFcc0000;
	...
	public boolean isTabItemClick = false;

	public int cur_page = 0;
	private List<ChanneDao> showList;
	// 是否处在主页新闻页,如果是,则点击每项时进行统计
	private boolean is_in_home = false;

	public List<ChanneDao> getShowList() {
		return showList;
	}

	public void setShowList(List<ChanneDao> showList) {
		this.showList = showList;
	}

	public void setInHome(boolean is_in_home) {
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs,
		...
		selectTabTextSize = (int) TypedValue.applyDimension(
				TypedValue.COMPLEX_UNIT_SP, selectTabTextSize, dm);
		...
		tab.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				MobclickAgent.onEvent(getContext(),
						StatisticalKey.channel_onclick);
				String channelid = null;
				if (is_in_home && showList != null && position < tabCount
						&& position < showList.size()) {
