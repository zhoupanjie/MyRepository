 ...
 * 公司圈
 */
public class CompanyCircleAdapter extends BaseAdapter<CompanyZoneList> {
    ...
    public CompanyCircleAdapter(Context context, OnCommentClickListener lis, View.OnClickListener optionLis) {
        super(context);
        mLis = lis;
    ...
    public View getView(int position, View view, ViewGroup arg2) {
        ...
        if (view == null) {
            ...
            hodler.imageContent = view.findViewById(R.id.ly_imgs);
        ...
        if (item.getParisadata() != null && !"0".equals(item.getParisadata().getConut())) {
            hodler.lyLike.setVisibility(View.VISIBLE);
            hodler.mNumZan.setText(item.getParisadata().getConut()+"人觉得很赞");
        } else {
    ...
    private void setImageLayout(View view, final CompanyZoneList item) {
        ...
        if (ListUtil.isEmpty(item.getExrta())) {
            setGone(viewHodler.imageContent);
        ...
        viewHodler.imageContent.setVisibility(View.VISIBLE);
