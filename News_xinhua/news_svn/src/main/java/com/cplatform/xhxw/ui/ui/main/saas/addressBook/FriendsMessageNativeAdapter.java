...
public class FriendsMessageNativeAdapter extends CursorAdapter {

	private LayoutInflater mInflater;

	public FriendsMessageNativeAdapter(Context context, Cursor c, int flags) {
	...
	public void bindView(View view, Context context, Cursor cursor) {
		...
		holder.content.setText(XWExpressionUtil.generateSpanComment(
                mContext, cursor.getString(cursor
        				.getColumnIndex(FriendsMessageDao.INFODATA)),
