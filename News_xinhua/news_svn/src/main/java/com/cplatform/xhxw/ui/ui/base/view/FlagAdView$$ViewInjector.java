...
public class FlagAdView$$ViewInjector {
  public static void inject(Finder finder, final com.cplatform.xhxw.ui.ui.base.view.FlagAdView target, Object source) {
    View view;
    view = finder.findById(source, 2131493827);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131493827' for field 'mTitle' was not found. If this view is optional add '@Optional' annotation.");
    }
