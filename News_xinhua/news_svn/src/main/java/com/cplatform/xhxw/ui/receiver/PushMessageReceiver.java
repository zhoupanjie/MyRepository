...
public class PushMessageReceiver extends FrontiaPushMessageReceiver {
    ...
    private static final PushMessageUtil.PushChannelType PUSH_CHANNEL_TYPE = PushMessageUtil.PushChannelType.baidu;
    ...
    public void onBind(Context context, int errorCode, String appid,
        ...
        if (errorCode == 0) {
            String pushChannel = context.getString(R.string.app_baidu_push_channel);
            PushMessageUtil.bindServer(context, Constants.getUid(), userId, channelId, pushChannel);
        }
    }
    ...
    public void onMessage(Context context, String message, String customContentString) {
        PushMessageUtil.message(App.CONTEXT, message, customContentString, PUSH_CHANNEL_TYPE);
    }
    ...
    public void onNotificationClicked(Context context, String title,
        ...
        PushMessageUtil.notificationClicked(context, title, description, customContentString, PUSH_CHANNEL_TYPE);
    ...
    public void onUnbind(Context context, int errorCode, String requestId) {
        ...
        // 解绑定成功，设置未绑定flag，
        if (errorCode == 0) {
            PushMessageUtil.unbindServer(context, Constants.getUid(), requestId);
        }
    }
