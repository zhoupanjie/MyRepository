 ...
 * additional parameters by passing a
 * {@link com.loopj.android.http.RequestParams} instance, and responses can be
 * handled by passing an anonymously overridden
...
public class AsyncHttpClient {
	...
	public AsyncHttpClient() {
		...
		httpClient.addRequestInterceptor(new HttpRequestInterceptor() {
			public void process(HttpRequest request, HttpContext context) {
				...
				HashMap<String, String> clientHeaderMap = (HashMap) HttpClientConfig
						.getHeader();
				...
				// clientHeaderMap.entrySet();
				// for (Iterator<Map.Entry<String, String>> it = set.iterator();
				// it.hasNext();) {
				// Map.Entry<String, String> entry = (Map.Entry<String, String>)
				// it.next();
				// Log.d("aaa",entry.getKey() + "--->" + entry.getValue());
				// }
				// Log.d("aaa", "-------------------------------");
				// Header[] h = request.getAllHeaders();
				// for (int i = 0; i < h.length; i++) {
				// Log.d("aaa", h[i].toString());
				// }
				// Log.d("aaa", "=====================================");
			}
		});
		...
		// clientHeaderMap = new Hashtable<String, String>();
	}
	 ...
	 *            {@link com.loopj.android.http.PersistentCookieStore}
	 */
	 ...
	 * 
	 * @param threadPool
	 *            an instance of {@link java.util.concurrent.ThreadPoolExecutor}
	...
	// clientHeaderMap.putAll(headers);
	// }
	...
	public void post(Context context, String url, HttpEntity entity,
		...
		Log.d("zxe_" + this.getClass().getName() + "获取Post请求Url", url);
		sendRequest(httpClient, httpContext,
