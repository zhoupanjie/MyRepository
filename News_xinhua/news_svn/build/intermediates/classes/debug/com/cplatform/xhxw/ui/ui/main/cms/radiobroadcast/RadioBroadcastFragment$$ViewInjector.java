...
public class RadioBroadcastFragment$$ViewInjector {
  public static void inject(Finder finder, final com.cplatform.xhxw.ui.ui.main.cms.radiobroadcast.RadioBroadcastFragment target, Object source) {
    View view;
    view = finder.findById(source, 2131427921);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131427921' for field 'mViewGroup' was not found. If this view is optional add '@Optional' annotation.");
    }
    target.mViewGroup = (android.view.ViewGroup) view;
    view = finder.findById(source, 2131427920);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131427920' for field 'ivSetting' was not found. If this view is optional add '@Optional' annotation.");
    }
