...
public class RecommendImagesActivity$$ViewInjector {
  public static void inject(Finder finder, final com.cplatform.xhxw.ui.ui.recommendimages.RecommendImagesActivity target, Object source) {
    View view;
    view = finder.findById(source, 2131428042);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131428042' for field 'recommendImages' was not found. If this view is optional add '@Optional' annotation.");
    }
