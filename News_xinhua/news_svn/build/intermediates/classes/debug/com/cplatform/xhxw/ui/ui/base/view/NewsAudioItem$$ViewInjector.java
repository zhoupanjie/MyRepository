...
public class NewsAudioItem$$ViewInjector {
  public static void inject(Finder finder, final com.cplatform.xhxw.ui.ui.base.view.NewsAudioItem target, Object source) {
    ...
    view = finder.findById(source, 2131428330);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131428330' for field 'mComment' was not found. If this view is optional add '@Optional' annotation.");
    }
