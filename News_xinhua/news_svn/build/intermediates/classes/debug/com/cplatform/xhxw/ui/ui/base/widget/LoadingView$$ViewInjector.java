...
public class LoadingView$$ViewInjector {
  public static void inject(Finder finder, final com.cplatform.xhxw.ui.ui.base.widget.LoadingView target, Object source) {
    View view;
    view = finder.findById(source, 2131427947);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131427947' for field 'mMsg' was not found. If this view is optional add '@Optional' annotation.");
    }
